...
def borrosificador(x):
    ...
    med_pos_N = (sup[1][1] + sup[1][0]) * 0.5 / 2
    med_pos_P = (sup[3][1] + sup[3][0]) * 0.5 / 2
...
def motor_inferencia(x):
    ...
    # ------------------------------------------
    # - COMBINACION DE MIS CONJUNTOS DE SALIDA -
    # ------------------------------------------
...
def desborrosificador(f):
    ...
    #
    # for item in sup:
    #     med.append((item[1] + item[0]) / 2)
    #
    # med[1] = (sup[1][1] + sup[1][0]) * 0.5 / 2
    # med[3] = (sup[3][1] + sup[3][0]) * 0.5 / 2
    #
    # med[6] = (sup[6][1] + sup[6][1]) * 0.7 / 2
    # med[8] = (sup[8][1] + sup[8][1]) * 0.7 / 2
    s_f = [2*[-11, -5], 2*[-7, -1], 2*[-3, 3], 2*[1, 7], 2*[5, 11]]
...
def control_difuso(x):
    """
    Controlador difuso
    :param x: vector de estado actual
    :return c: fuerza de control
    """
